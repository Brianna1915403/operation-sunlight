...
public class DeviceSelectionFragment extends Fragment implements OnDeviceListener {
    private View root;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        root = inflater.inflate(R.layout.fragment_device_selection, container, false);
...
//            View view = root.findViewById(R.id.recyclerViewDevice);
    ...
    public void onDeviceClick(String device_name, String device_address) {
        ...
        navController.navigate(R.id.nav_greenhouse_controller, bundle);
    }
}